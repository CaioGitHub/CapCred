...
public class PaymentController implements PaymentPortIn {
    ...
    @PreAuthorize("@accessValidator.canAccess(#installmentId, authentication)")
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "403", description = "Not has permission to pay installment", content = @Content),
